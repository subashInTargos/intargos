...
var App = function() {
    ...
    var uiInit = function() {
        ...
        // Initialize Typeahead - KYC Document List
        var documentsTypeheadData = ["GST Certificate","Rent Agreement","Certificate of Incorporation","Partnership Deed","Electricity Bill","Phone Bill","Others"];
        $('.input-typeahead_docs').typeahead({ source: documentsTypeheadData });
