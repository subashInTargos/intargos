...
-->
    <header class="navbar navbar-default">
        ...
        <ul class="nav navbar-nav-custom">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-custom dropdown-options">
                    ...
                    <li class="dropdown-header text-center">Theme Color</li>

                    <ul class="sidebar-section sidebar-themes clearfix" style="opacity: 1;">
                        <!-- <li class="active">
                    ...
                    <li>
                        <div class="btn-group btn-group-justified btn-group-sm">
                            <a href="javascript:void(0)" class="btn btn-warning" id="save-theme">Save Theme</a>
                            <!-- <a href="javascript:void(0)" class="btn btn-primary" id="options-main-style-alt">Alternative</a> -->
                        </div>
                    </li>
                </ul>
        ...
        <ul class="nav navbar-nav-custom pull-right">
            ...
            <li class="dropdown">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?= base_url();?>assets/img/placeholders/avatars/avatar<?php echo $this->session->userdata['user_session']['avatar'];?>.png" alt="ParcelX Admin"> <i class="fa fa-angle-down"></i>
                </a>
                <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                    <li class="dropdown-header text-center"><?php echo $this->session->userdata['user_session']['admin_username']; ?></li>
                    <!-- <li>
                    ...
                    <!-- <li class="divider"></li> -->
                    <li>
                        <a href="page_ready_user_profile.html"><i class="fa fa-user fa-fw pull-right"></i>Profile</a>
                        <!-- Opens the user settings modal that can be found at the bottom of each page (page_footer.html in PHP version) -->
                        <a href="#modal-user-settings" data-toggle="modal"><i class="fa fa-cog fa-fw pull-right"></i>Settings</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <!-- <a href="page_ready_lock_screen.html"><i class="fa fa-lock fa-fw pull-right"></i> Change Password</a> -->
                        <a href="<?= base_url(); ?>authentication/logout"><i class="fa fa-sign-out fa-fw pull-right"></i> Logout</a>
                    </li>
