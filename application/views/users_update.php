                                            ...
                                            <div class="component-group">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="express_type[]" id="express_type" class="form-control">
                                                        <?php if($row->express == 'air'){ ?>
                                                            <option value="air" selected>Air</option>
                                                        <?php }else if($row->express == 'surface'){ ?>
                                            ...
                                            <div class="component-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <?php 
                                                        ...
                                                        {
                                                            if($rows->weightslab_id == $row->weightslab_id)
                                                            {
                                                        ?>
                                                            <option selected value="<?php echo $rows->weightslab_id ?>"><?php echo $rows->slab_title ?></option>
                                                        <?php
                                                            }
                                                            else
                                                            {
                                                        ?>
                                                            <option value="<?php echo $rows->weightslab_id; ?>"><?php echo $rows->slab_title; ?></option>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
