    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <form method="post" id="form_allpayments" action="" class="form-horizontal form-bordered">
        ...
        <script>
            $(function(){
                ...
                search_data("form_allpayments","<?= base_url();?>actionsearch/search_allpayments/0");
            });
            ...
            $(document).on('click', '.pagination li a', function(event)
            {
                ...
                search_data("form_allpayments","<?= base_url();?>actionsearch/search_allpayments/"+(page-1)*100);
            });
        </script>
